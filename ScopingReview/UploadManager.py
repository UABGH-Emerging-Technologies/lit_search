...
class FastAPIUploadManager(UploadManager):
    def read_file(self, file: bytes, extension: str) -> Union[pd.DataFrame, str]:
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"Invalid file format or corrupted file: {str(e)}") from e

# TODO: This could probably go in llm_utils with each package expected to implement read_file()
